    ...
    public Mee7() {
        ...
        try {
            ...
            jda = JDABuilder
                    ...
                    .addEventListeners(new CrazyWallsCommand())
                    ...
                    .addEventListeners(new McGoCommand())
					.addEventListeners(new MediasCommand())
                    .addEventListeners(new MegaWallsCommand())
                    .addEventListeners(new MemeCommand())
                    .addEventListeners(new MurderMysteryCommand())
                    ...
                    .addEventListeners(new SkyClashCommand())
